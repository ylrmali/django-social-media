    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follower', models.ManyToManyField(blank=True, null=True, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_media', models.FileField(blank=True, null=True, upload_to='')),
                ('is_active', models.BooleanField(default=True)),
                ('like_count', models.IntegerField(blank=True, default=0, editable=False, null=True)),
                ('comment_count', models.IntegerField(blank=True, default=0, editable=False, null=True)),
                ('like_owner', models.ManyToManyField(related_name='post_like', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_media', models.FileField(blank=True, null=True, upload_to='')),
                ('comment_like', models.IntegerField(blank=True, default=0, null=True)),
                ('created_time', models.DateTimeField(auto_now_add=True)),
